...
from heppy.analyzers.examples.hgammagamma.JetEnergyComputer import JetEnergyComputer
...
# implement a chi2? 
from heppy.analyzers.examples.hgammagamma.ZHReconstruction import ZHReconstruction
zhreco = cfg.Analyzer(
    ZHReconstruction,
    output_higgs='higgs',
    output_zed='zed', 
